#!/usr/bin/env python3
"""Vendor a macOS arm64 DCCCcore release asset into dcccpy-macos-runtime."""
...
DEFAULT_VERSION = "4.5.1-alpha"
DEFAULT_RELEASE_PLATFORM = "macos-latest-arm64"
...
def main() -> int:
    ...
    dest = project_root / "src" / "dcccpy_macos_runtime" / "vendor" / "dccccore" / "macos-arm64"
    ...
    with tempfile.TemporaryDirectory(prefix="dcccpy-macos-runtime-") as temp_name:
        temp = Path(temp_name)
