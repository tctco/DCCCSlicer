#!/usr/bin/env python3
"""Vendor a Linux ARM64 DCCCcore release into dcccpy-linux-arm64-runtime."""
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="dcccpy-linux-arm64-runtime-") as temp_name:
        temp = Path(temp_name)
