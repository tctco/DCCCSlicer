#!/usr/bin/env python3
"""Vendor a Linux DCCCcore release asset into dcccpy-linux-runtime."""
...
def main() -> int:
    ...
    dest = project_root / "src" / "dcccpy_linux_runtime" / "vendor" / "dccccore" / "linux-x86_64"
    ...
    with tempfile.TemporaryDirectory(prefix="dcccpy-linux-runtime-") as temp_name:
        temp = Path(temp_name)
