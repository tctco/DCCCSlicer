...
class AbetaLoadCLI : public IMetricCLI {
public:
    ...
    std::string getDescription() const override {
        return "AbetaLoad estimation using NS/K decomposition";
    }
...
MetricCLIPtr createCLI() {
    return std::make_shared<AbetaLoadCLI>();
}
